...
public class TesterLayoutDSI_parell {
...
//    }
    ...
    public TesterLayoutDSI_parell RunThread(String variant, String reference, String version, String TesterName, String TesterID, int Columns, int Rows, ObservableList<SystemPintable> systemPintableXML) {
                                        ...
                                        for (Section6_Model section6_model_DrwConn : DSI_Model.getSection6_models()) {
                                            ...
                                            if (section4_model.getFirst_Point().equals(section6_model_DrwConn.getRef_BSJ())) {
                                                if (section6_model_DrwConn.getComp_Type().equals("CONNECTOR")) {
                                                    ...
                                                    /**for (Cell cell : model.getAddedCells()) {*/
                                                    String[] finalVariants1 = variants;
                                                    model.getAddedCells().forEach(cell -> {
                                                                if (cell.getCellId().equals(section6_model_DrwConn.getRef_BSJ())) {
                                                                    Cell pasiveCell = new Cell("Cav: " + section6_model_DrwConn.getCavity() + " / " + section6_model_DrwConn.getComp_Type(), CellType.COMPONENT.name(), section6_model_DrwConn.getName(), section6_model_DrwConn.getPart_Nb(), "", section6_model_DrwConn.getComp_Type(), Arrays.asList(finalVariants1.clone()));
                                                                    pasiveCell.getPositionXProperty().bind(cell.getPositionXProperty());
                                                                    pasiveCell.getPositionYProperty().bind(cell.getPositionYProperty());
                                                                    cell.addPasives(pasiveCell);
                                                                }
                                            ...
                                            if (section4_model.getSecond_Point().equals(section6_model_DrwConn.getRef_BSJ())) {
                                                if (section6_model_DrwConn.getComp_Type().equals("CONNECTOR")) {
                                                    ...
                                                    model.getAddedCells().forEach(cell -> {
                                                                if (cell.getCellId().equals(section6_model_DrwConn.getRef_BSJ())) {
                                                                    Cell pasiveCell = new Cell("Cav: " + section6_model_DrwConn.getCavity() + " / " + section6_model_DrwConn.getComp_Type(), CellType.COMPONENT.name(), section6_model_DrwConn.getName(), section6_model_DrwConn.getPart_Nb(), "", section6_model_DrwConn.getComp_Type(), Arrays.asList(finalVariants.clone()));
                                                                    pasiveCell.getPositionXProperty().bind(cell.getPositionXProperty());
                                                                    pasiveCell.getPositionYProperty().bind(cell.getPositionYProperty());
                                                                    cell.addPasives(pasiveCell);
                                                                }
