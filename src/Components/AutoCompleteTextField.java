...
public class AutoCompleteTextField<S> extends TextField
{
    ...
    private String textOccurenceStyle = "-fx-font-weight: bold; "
            + "-fx-fill: gold;";
    private String textNormalStyle = "-fx-font-weight: italic; "
            + "-fx-fill: gray;";
            ...
            } else
            {
                ...
                if (!entries.isEmpty())
                {
                    ...
                    if (!isPopupHidden())
                    {
                        ...
                        {
                            entriesPopup.show(AutoCompleteTextField.this, Side.TOP, 0, 0);
                        }
                    }
                } else
                {
    ...
    private void populatePopup(List<S> searchResult, String text)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            pre.setStyle(getTextNormalStyle());
            ...
            post.setStyle(getTextNormalStyle());
    ...
    public String getTextNormalStyle()
    {
        return textNormalStyle;
    }
