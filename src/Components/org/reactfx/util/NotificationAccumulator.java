...
import Components.org.reactfx.collection.ListModificationSequence;
import Components.org.reactfx.collection.LiveList.Observer;
import Components.org.reactfx.collection.QuasiListChange;
...
public interface NotificationAccumulator<O, V, A> {
    ...
    static <E> NotificationAccumulator<Observer<? super E, ?>, QuasiListChange<? extends E>, ListModificationSequence<E>> listNotifications() {
...
extends NotificationAccumulatorBase<Observer<? super E, ?>, QuasiListChange<? extends E>, ListModificationSequence<E>>
