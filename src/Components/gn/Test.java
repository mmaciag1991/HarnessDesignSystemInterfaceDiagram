 ...
 */
package Components.gn;

import Components.gn.decorator.GNDecorator;
import Components.gn.decorator.buttons.ButtonTest;
...
//        Parent root = FXMLLoader.load(getClass().getResource("/com/Components.gn/resources/sample.fxml"));
...
//        window.getScene().getStylesheets().addAll(getClass().getResource("/com/Components.gn/resources/css/custom.css").toExternalForm());
