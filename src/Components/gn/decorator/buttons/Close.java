...
package Components.gn.decorator.buttons;
...
public class Close extends Button {
    ...
    private static final String USER_AGENT_STYLESHEET = GNBackground.class.getResource("/Components/gn/resources/css/controls/buttons.css").toExternalForm();
    private final ImageView viewClose = new ImageView(new Image("/Components/gn/resources/img/close.png"));
    
    public Close(){
        getStyleClass().add("Components.gn-close");
    ...
    public void setDefaultFill(Paint color) {
        ...
        this.setStyle("-Components.gn-fill : white");
    }

    private static class StyleableProperties {

        private static final CssMetaData<Close, Paint> DEFAULT_FILL
                = new CssMetaData<Close, Paint>("-Components.gn-fill",
