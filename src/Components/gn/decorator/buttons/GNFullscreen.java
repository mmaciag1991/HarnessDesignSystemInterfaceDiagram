...
public class GNFullscreen extends Button  {
    ...
    private final ImageView viewFullScreen = new ImageView(new Image("/Components/gn/resources/img/fullscreen.png"));
    private final ImageView viewUnFullScreen = new ImageView(new Image("/Components/gn/resources/img/unfullscreen.png"));
    
    public GNFullscreen(){
        getStyleClass().add("Components.gn-full-screen");
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/Components/gn/resources/css/controls/buttons.css").toExternalForm();
    }
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<GNFullscreen, Paint> DEFAULT_FILL
                = new CssMetaData<GNFullscreen, Paint>("-Components.gn-fill",
