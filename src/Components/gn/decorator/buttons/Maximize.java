...
public class Maximize extends Button {
    ...
    private final ImageView viewRestore = new ImageView(new Image("/Components/gn/resources/img/restore.png"));
    
    public Maximize(){
        getStyleClass().add("Components.gn-maximize");
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<Maximize, Paint> DEFAULT_FILL
                = new CssMetaData<Maximize, Paint>("-Components.gn-fill",
