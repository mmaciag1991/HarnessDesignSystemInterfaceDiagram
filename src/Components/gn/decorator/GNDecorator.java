 ...
 */
package Components.gn.decorator;

import Components.gn.decorator.background.GNBackground;
import Components.gn.decorator.buttons.Close;
import Components.gn.decorator.buttons.GNFullscreen;
import Components.gn.decorator.buttons.Maximize;
import Components.gn.decorator.buttons.Minimize;
...
public class GNDecorator {
    ...
    private final ImageView viewMinimize    = new ImageView(new Image("/Components/gn/resources/img/minimize.png"));
    private final ImageView viewMaximize    = new ImageView(new Image("/Components/gn/resources/img/maximize.png"));
    private final ImageView viewClose       = new ImageView(new Image("/Components/gn/resources/img/close.png"));
    private static ImageView viewLogo       = new ImageView();
    ...
    public HBox getBar_content() {
        return bar_content;
    }

    public HBox getTitle_content() {
...
//            }
    ...
    private void configStage() {
        ...
        this.scene = new Scene(background, 1024, 668, true,  SceneAntialiasing.BALANCED);
    ...
    private void configLayout() {
        this.background.getStyleClass().add("Components.gn-decorator");
        this.body.getStyleClass().add("Components.gn-body");
        this.title.getStyleClass().add("Components.gn-title");
        this.container.getStyleClass().add("Components.gn-container");
        ...
        this.bar_content.getChildren().addAll(controls());
...
//        this.setStyle("-fx-border-color : #808080; -fx-border-width : 1");
    ...
    private AnchorPane bar(){
        bar.getStyleClass().add("Components.gn-bar");
    ...
    private HBox controls(){
        controls.getStyleClass().add("Components.gn-buttons");
    ...
    private MenuBar menu(){
        menus.getStyleClass().add("Components.gn-menu-bar");
        menus.setMinWidth(barHeight.get());
...
//    @Deprecated
    public void setIcon(Node node){
        node.setTranslateX(14);
        node.setTranslateY(8);
        bar.getChildren().add(node);
    }

    public static Button logo = new Button("Stan:" , viewLogo);
    public void setLogo(Image logoImg){
        viewLogo.setImage(logoImg);
        viewLogo.setFitWidth(32);
        viewLogo.setFitHeight(32);

        logo.setContentDisplay(ContentDisplay.RIGHT);

        logo.setStyle("  -fx-padding: 5 5 5 5;\n" +
        ...
        controls.getChildren().add(0,logo);
    }

    public static Button getLogoBtn(){
        return logo;
    }
    public static ImageView getViewLogo(){
        return viewLogo;
    }
    ...
    /**
     * Sets the body of the TesterLayout.application as background.
    ...
    /**
     * Sets the body of the TesterLayout.application as background. This method makes the content occupy every area of the
...
//        bar.toFront();
    ...
    /**
     * Sets the body of the TesterLayout.application as background. This method makes the
...
//        node.toBack();
    ...
    private void updateControls(Control control){
        ...
        control.getProperties().put("custom-control", "Components.gn-custom-control");
...
//        node.toBack();
    ...
    public void hideControls(){
        controls.getChildren().stream()
                .filter(e -> e instanceof Control && e.getProperties().containsValue("Components.gn-custom-control"))
    ...
    public void addMenu(Menu menu){
        menu.getStyleClass().add("Components.gn-menu-item");
    ...
    private GNFullscreen fullScreen(){
        btn_fullScreen.updateState(true );
        controls.getChildren().addAll(btn_fullScreen);
    ...
    public void initTheme(Theme theme){
        switch(theme){
            case DEFAULT :
                ...
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/default.css").toExternalForm());
                break;
            case DARK :
                this.background.getStylesheets().clear();
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/default.css").toExternalForm());
            ...
            case DANGER:
                this.background.getStylesheets().clear();
                // add theme
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/danger.css").toExternalForm());
                break;
            case INFO :
                this.background.getStylesheets().clear();
                // add theme
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/info.css").toExternalForm());
            break;
            case PRIMARY:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/primary.css").toExternalForm());
            break;
            case SECONDARY:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/secondary.css").toExternalForm());
            break;
            case SUCCESS:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/success.css").toExternalForm());
                break;
            case WARNING:
                this.background.getStylesheets().clear();
                // add css
                this.background.getStylesheets().add(getClass().getResource("/Components/gn/resources/css/theme/warning.css").toExternalForm());
                break;
            case CUSTOM:
                this.background.getStylesheets().clear();
                // add css
