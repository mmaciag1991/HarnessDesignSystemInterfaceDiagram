    ...
    void initTimeline() {
        ...
        setTimeline(new Timeline(
                ...
                new KeyFrame(Duration.millis(600),
                        new KeyValue(getNode().rotateProperty(), 180, Interpolator.EASE_IN)

                ),
                new KeyFrame(Duration.millis(800),
                        new KeyValue(getNode().rotateProperty(), 270, Interpolator.EASE_IN)
                ),
                new KeyFrame(Duration.millis(1000),
                        //new KeyValue(getNode().opacityProperty(), 1, Interpolator.EASE_IN),
                        new KeyValue(getNode().rotateProperty(), 360, Interpolator.EASE_IN)
                )
        ));
