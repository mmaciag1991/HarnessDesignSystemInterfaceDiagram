...
import Components.hansolo.tilesfx.TimeSection.TimeSectionEvent;
...
public class TimeSectionBuilder<B extends TimeSectionBuilder<B>> {
    ...
    public final B icon(final Image IMAGE) {
        properties.put("resources/icon", new SimpleObjectProperty<>(IMAGE));
        return (B)this;
    }
    ...
    public final TimeSection build() {
        ...
        for (String key : properties.keySet()) {
            ...
            } else if("resources/icon".equals(key)) {
