...
public class Section implements Comparable<Section> {
    ...
    /**
     * Returns the resources.image that was defined for the section.
     * In some skins the resources.image will be drawn (e.g. SimpleSkin).
     * @return the resources.image that was defined for the section
     */
    public Image getImage() { return null == icon ? _icon : icon.get(); }
    /**
     * Defines an resources.image for the section.
     * In some skins the resources.image will be drawn (e.g. SimpleSkin)
     * @param IMAGE
     */
    ...
    public ObjectProperty<Image> iconProperty() {
        if (null == icon) {
            icon = new ObjectPropertyBase<Image>(_icon) {
                @Override protected void invalidated() { fireSectionEvent(UPDATE_EVENT); }
                @Override public Object getBean() { return Section.this; }
                @Override public String getName() { return "resources/icon"; }
            };
        }
        return icon;
    }
    ...
    /**
     * Returns the resources.style class that can be used to colorize the section.
     * This is not implemented in the current available skins.
     * @return the resources.style class that can be used to colorize the section
     */
    public String getStyleClass() { return styleClass; }
    /**
     * Defines the resources.style class that can be used to colorize the section.
     * This is not implemented in the current available skins.
     * @param STYLE_CLASS
     */
