...
import Components.hansolo.tilesfx.tools.MovingAverage;
import Components.hansolo.tilesfx.tools.Statistics;
...
public class StockTileSkin extends TileSkin {
    ...
    @Override protected void initGraphics() {
        ...
        valueText = new Text(/*String.format(locale, formatString, tile.getValue())*/(int)tile.getValue()+" mb");
    ...
    @Override protected void handleCurrentValue(final double VALUE) {
        ...
        if(!dataList.isEmpty()) {
            ...
            changeText.setText(/*String.format(locale, "%." + tile.getTickLabelDecimals() + "f", (VALUE - referenceValue))*/(int)(VALUE - referenceValue)+" mb");
        ...
        if (tile.getCustomDecimalFormatEnabled()) {
            ...
            valueText.setText((int)VALUE+" mb");
        }

        highText.setText(/*String.format(locale, formatString, high)*/(int)high+" mb");
        lowText.setText(/*String.format(locale, formatString, low)*/(int)low+" mb");
