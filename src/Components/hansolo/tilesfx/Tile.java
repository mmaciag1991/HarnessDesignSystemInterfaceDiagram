...
import Components.hansolo.tilesfx.chart.ChartData;
import Components.hansolo.tilesfx.chart.RadarChartMode;
import Components.hansolo.tilesfx.chart.SunburstChart;
import Components.hansolo.tilesfx.chart.TilesFXSeries;
import Components.hansolo.tilesfx.colors.Bright;
import Components.hansolo.tilesfx.events.*;
import Components.hansolo.tilesfx.events.TileEvent.EventType;
import Components.hansolo.tilesfx.events.TimeEvent.TimeEventType;
import Components.hansolo.tilesfx.fonts.Fonts;
import Components.hansolo.tilesfx.skins.*;
import Components.hansolo.tilesfx.tools.*;
...
import static Components.hansolo.tilesfx.tools.Helper.clamp;
import static Components.hansolo.tilesfx.tools.MovingAverage.MAX_PERIOD;
...
public class Tile extends Control {
    ...
    public  static final Color              FORESTGREEN                           = TileColor.FORESTGREEN.color;
    ...
    public ObjectProperty<Image> imageProperty() {
        if (null == image) {
            image = new ObjectPropertyBase<Image>() {
                @Override protected void invalidated() { fireTileEvent(RESIZE_EVENT); }
                @Override public Object getBean() { return Tile.this; }
                @Override public String getName() { return "resources/image"; }
            };
        }
        return image;
    }
    ...
    /**
     * Returns true if the resources.icon of the sections should be drawn inside
     * the sections. This is currently only used in the SimpleSkin.
     *
     * @return true if the resources.icon of the sections should be drawn
     */
    public boolean getSectionIconsVisible() { return null == sectionIconsVisible ? _sectionIconsVisible : sectionIconsVisible.get(); }
    /**
     * Defines if the resources.icon of the sections should be drawn inside
     * the sections. This is currently only used in the SimpleSkin.
     *
     * @param VISIBLE
     */
    ...
    /**
     * Returns the color that will be used to colorize the alarm resources.icon.
     * @return the color that will be used to colorize the alarm resources.icon
     */
    public Color getAlarmColor() { return null == alarmColor ? _alarmColor : alarmColor.get(); }
    /**
     * Defines the color that will be used to colorize the alarm resources.icon
     * @param COLOR
     */
