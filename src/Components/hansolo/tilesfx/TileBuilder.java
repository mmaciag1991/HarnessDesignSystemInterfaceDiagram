...
import Components.hansolo.tilesfx.chart.SunburstChart.VisibleData;
import Components.hansolo.tilesfx.chart.TilesFXSeries;
import Components.hansolo.tilesfx.colors.Bright;
import Components.hansolo.tilesfx.events.AlarmEventListener;
import Components.hansolo.tilesfx.events.TileEventListener;
import Components.hansolo.tilesfx.events.TimeEventListener;
...
public class TileBuilder<B extends TileBuilder<B>> {
    ...
    public final B image(final Image IMAGE) {
        properties.put("resources/image", new SimpleObjectProperty(IMAGE));
        return (B)this;
    }
    ...
    public final Tile build() {
        ...
        for (String key : properties.keySet()) {
            ...
            } else if ("resources/style".equals(key)) {
            ...
            } else if ("resources/image".equals(key)) {
