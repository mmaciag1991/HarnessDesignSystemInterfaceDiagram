 ...
 */
package Components.hansolo.tilesfx.fonts;
...
public class Fonts {
    ...
    static {
        try {
            latoLightName              = Font.loadFont(Fonts.class.getResourceAsStream("/Components/hansolo/tilesfx/fonts/Lato-Lig.otf"), 10).getName();
            latoRegularName            = Font.loadFont(Fonts.class.getResourceAsStream("/Components/hansolo/tilesfx/fonts/Lato-Reg.otf"), 10).getName();
            latoBoldName               = Font.loadFont(Fonts.class.getResourceAsStream("/Components/hansolo/tilesfx/fonts/Lato-Bol.otf"), 10).getName();
