 ...
 */
package Components.hansolo.tilesfx.chart;

import Components.hansolo.tilesfx.Tile;
import Components.hansolo.tilesfx.events.ChartDataEvent;
import Components.hansolo.tilesfx.events.ChartDataEvent.EventType;
import Components.hansolo.tilesfx.events.ChartDataEventListener;
import Components.hansolo.tilesfx.tools.GradientLookup;
import Components.hansolo.tilesfx.tools.Location;
...
public class ChartData implements Comparable<ChartData> {
    ...
    public ChartData(final Image IMAGE, final String NAME, final double VALUE, final Color FILL_COLOR, final Color STROKE_COLOR, final Color TEXT_COLOR, final Instant TIMESTAMP, final
        ...
        currentDuration    = new ObjectPropertyBase<java.time.Duration>(duration) {
            @Override protected void invalidated() {
        ...
        currentTimestamp   = new ObjectPropertyBase<Instant>(timestamp) {
            @Override protected void invalidated() {
    ...
    @Override public int compareTo(final ChartData DATA) {
