 ...
 */
package Components.hansolo.tilesfx.addons;
...
public class HappinessIndicator extends Region {
    ...
    public HappinessIndicator(final Happiness HAPPINESS, final double VALUE) {
        happiness          = new ObjectPropertyBase<Happiness>(HAPPINESS) {
        ...
        barBackgroundColor = new ObjectPropertyBase<Color>(Tile.BACKGROUND.brighter()) {
            @Override protected void invalidated() { redraw(); }
            @Override public Object getBean() { return HappinessIndicator.this; }
            @Override public String getName() { return "barBackgroundColor"; }
        };
        textColor          = new ObjectPropertyBase<Color>(Tile.FOREGROUND) {
        ...
        happyColor         = new ObjectPropertyBase<Color>(Tile.GREEN) {
            @Override protected void invalidated() { redraw(); }
            @Override public Object getBean() { return HappinessIndicator.this; }
            @Override public String getName() { return "happyColor"; }
        };
        neutralColor       = new ObjectPropertyBase<Color>(Tile.YELLOW_ORANGE) {
            @Override protected void invalidated() { redraw(); }
            @Override public Object getBean() { return HappinessIndicator.this; }
            @Override public String getName() { return "neutralColor"; }
        };
        unhappyColor       = new ObjectPropertyBase<Color>(Tile.RED) {
            @Override protected void invalidated() { redraw(); }
            @Override public Object getBean() { return HappinessIndicator.this; }
