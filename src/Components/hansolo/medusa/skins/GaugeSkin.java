...
package Components.hansolo.medusa.skins;

import Components.hansolo.medusa.*;
import Components.hansolo.medusa.Gauge.LedType;
import Components.hansolo.medusa.Gauge.NeedleBehavior;
import Components.hansolo.medusa.Gauge.NeedleType;
import Components.hansolo.medusa.Gauge.ScaleDirection;
import Components.hansolo.medusa.tools.AngleConicalGradient;
...
import static Components.hansolo.medusa.tools.Helper.formatNumber;
...
public class GaugeSkin extends GaugeSkinBase {
    ...
    @Override protected void handleEvents(final String EVENT_TYPE) {
        ...
        if ("FINISHED".equals(EVENT_TYPE)) {
            ...
            // Components.hansolo.medusa.Check sections for value and fire section events
            if (gauge.getCheckSectionsForValue()) {
                int listSize = sections.size();
                for (int i = 0 ; i < listSize ; i++) { sections.get(i).checkForValue(currentValue); }
            }

            // Components.hansolo.medusa.Check areas for value and fire section events
