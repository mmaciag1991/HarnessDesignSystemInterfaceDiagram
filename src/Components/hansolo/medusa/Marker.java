...
public class Marker implements Comparable<Marker>{
    ...
    /**
     * Returns the resources.style class that can be used to colorize the marker.
     * This is not implemented in the current available skins.
     * @return the resources.style class that can be used to colorize the marker
     */
    public String getStyleClass() { return styleClass; }
    /**
     * Defines the resources.style class that can be used to colorize the marker.
