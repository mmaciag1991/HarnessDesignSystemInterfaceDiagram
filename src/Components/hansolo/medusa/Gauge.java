...
import Components.hansolo.medusa.events.UpdateEvent;
import Components.hansolo.medusa.events.UpdateEventListener;
import Components.hansolo.medusa.skins.*;
import Components.hansolo.medusa.tools.*;
...
public class Gauge extends Control {
     ...
     * more flat resources.style you should set this to false.
     *
    ...
    /**
     * Returns true if the resources.icon of the areas should be drawn inside
     * the areas.
     *
     * @return true if the resources.icon of the areas should be drawn
     */
    public boolean getAreaIconsVisible() { return null == areaIconsVisible ? _areaIconsVisible : areaIconsVisible.get(); }
    /**
     * Defines if the resources.icon of the areas should be drawn inside
     * the areas.
     *
     * @param VISIBLE
     */
     ...
     * embedded devices because it will calculate a bitmap resources.image where
