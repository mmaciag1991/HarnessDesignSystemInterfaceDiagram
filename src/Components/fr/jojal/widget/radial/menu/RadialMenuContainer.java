...
public class RadialMenuContainer extends RadialMenuItem {
	...
	public RadialMenuContainer() {
        ...
        Image unchecked = new Image("/resources/images/arrow.png");
...
//        getPath().addEventFilter(MouseEvent.MOUSE_ENTERED, event -> {
//            setChildrenVisible(true);
//            event.consume();
//        });
//        getPath().addEventFilter(MouseEvent.MOUSE_EXITED, event -> {
//            setChildrenVisible(false);
//            event.consume();
//        });
