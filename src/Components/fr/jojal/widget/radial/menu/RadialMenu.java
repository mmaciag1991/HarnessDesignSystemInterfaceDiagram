...
public class RadialMenu extends Group {
	...
	public RadialMenu(double innerRadius, double outerRadius, double length, double gap, ImageView logo, RadialMenuItem... items) {
		...
		logo.setLayoutX(getLayoutX()+(getLayoutBounds().getWidth()/2)-(logo.getFitWidth()/2));
		logo.setLayoutY(getLayoutY()+(getLayoutBounds().getHeight()/2)-(logo.getFitHeight()/2));
