...
package _TryyClass.map.world;

import _TryyClass.map.heatmap.ColorMapping;
import _TryyClass.map.heatmap.HeatMap;
import _TryyClass.map.heatmap.HeatMapBuilder;
...
public class World extends Region {
    ...
    private static final String                          HIRES_PROPERTIES = "_TryyClass/map/hires.properties";
    private static final String                          LORES_PROPERTIES = "_TryyClass/map/lores.properties";
    ...
    public World(final Resolution RESOLUTION, final ColorMapping COLOR_MAPPING, final double EVENT_RADIUS, final boolean FADE_COLORS, final OpacityDistribution OPACITY_DISTRIBUTION, final double HEAT_MAP_OPACITY) {
        ...
        //locationIconCode     = MaterialDesign.TEAL;
        pane                 = new Pane();
        group                = new Group();
  ...
  //  public void addEvents(final Point2D... EVENTS) { heatMap.addEvents(EVENTS); }
     ...
     * @param EVENTS
     */
    public void addEvents(final HashMap<Point2D,String> EVENTS) { heatMap.addEvents(EVENTS); }
