...
//        Anchor control2 = new Anchor(Color.GOLDENROD, curve.controlX2Property(), curve.controlY2Property());
    ...
    private CubicCurve createStartingCurve() {
        ...
        curve.setStartX(100);
        curve.setStartY(100);
        curve.setControlX1(curve.getStartX()+100);
        curve.setControlY1(curve.getStartY()+100);
        curve.setControlX2(curve.getEndX()+100);
        curve.setControlY2(curve.getEndY()+100);
        curve.setEndX(300);
        curve.setEndY(100);
        curve.setStroke(Color.FORESTGREEN);
        curve.setStrokeWidth(4);
        curve.setStrokeLineCap(StrokeLineCap.SQUARE);
        curve.setFill(Color.ROSYBROWN.deriveColor(0, 1.2, 1, 0.6));
        curve.controlX1Property().bind(curve.startXProperty().add(-30));
        curve.controlY1Property().bind(curve.startYProperty().add(-30));
        curve.controlX2Property().bind( curve.endXProperty().add(30));
        curve.controlY2Property().bind( curve.endYProperty().add(30));
        return curve;
    }
